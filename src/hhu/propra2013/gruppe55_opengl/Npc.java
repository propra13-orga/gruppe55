...
public class Npc extends LivingObject {	
	...
	public Rectangle getBorder(){
		...
		if(state[currState].visible){
			return new Rectangle(x + offset2[1], y + offset2[0], state[currState].getTexture().getTextureWidth() -offset2[1]-offset2[3], state[currState].getTexture().getTextureHeight()-offset2[0]-offset2[2]);
		}		
		   else
