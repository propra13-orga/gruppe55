...
public class Spell_SnowFlake extends Projectile {
	...
	public Spell_SnowFlake(double x, double y, int angle, int dmg) {
		super(x, y, angle, dmg);
	...
	public Spell_SnowFlake launch(double x, double y, int angle, int dmg){
		return new Spell_SnowFlake(x,y,angle,dmg);
	}
